...
syntax CatchFormalParameter = CatchType VarDec
;
...
syntax InterfaceMethodDec =
   abstractMethodDec: (Anno | InterfaceMethodMod)* TypeParams? ResultType Id "(" {FormalParam ","}* ")" Throws? MethodBody  
  |  deprAbstractMethodDec: (Anno | AbstractMethodMod)* TypeParams? ResultType Id "(" {FormalParam ","}* ")" Dim+ Throws? ";" 
  ;
